...
void setup() {
  ...
  if (!SD.begin(SDCARD_CS_PIN)) {
    ...
    // dlyFbMixer is the feedback-adding mixer, dlyMixer the whole delay (with/without feedback) mixer
    dlyFbMixer.gain(0, 1.0); // original signal
    dlyFbMixer.gain(1, mapfloat(effect_delay_feedback, 0, ENC_DELAY_FB_STEPS, 0.0, 1.0)); // amount of feedback
