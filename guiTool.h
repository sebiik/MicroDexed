...
AudioConnection          patchCord5(noise1, 0, dlyMixer, 3); //seb
AudioConnection          patchCord6(dlyFbMixer, delay1);
AudioConnection          patchCord7(dlyFbMixer, 0, dlyMixer, 1);

#if defined(TEENSY_AUDIO_BOARD)
AudioOutputI2S           i2s1;
AudioConnection          patchCord8(dlyMixer, 0, i2s1, 0);
AudioConnection          patchCord9(dlyMixer, 0, i2s1, 1);
AudioControlSGTL5000     sgtl5000_1;
#elif defined(TGA_AUDIO_BOARD)
AudioOutputI2S           i2s1;
AudioAmplifier           volume_r;
AudioAmplifier           volume_l;
AudioConnection          patchCord8(dlyMixer, volume_r);
AudioConnection          patchCord9(dlyMixer, volume_l);
AudioConnection          patchCord10(volume_r, 0, i2s1, 1);
AudioConnection          patchCord11(volume_l, 0, i2s1, 0);
AudioControlWM8731master wm8731_1;
#elif defined(TEENSY_DAC)
AudioOutputAnalogStereo  dacOut;
AudioConnection          patchCord10(volume_r, 0, dacOut, 0);
AudioConnection          patchCord11(volume_l, 0, dacOut, 1);
#elif defined(TEENSY_DAC_SYMMETRIC)
AudioOutputAnalogStereo  dacOut;
AudioMixer4              invMixer;
AudioConnection          patchCord10(volume_l, 0, dacOut  , 0);
AudioConnection          patchCord11(volume_l, 0, invMixer, 0);
...
AudioAmplifier           volume_r;
AudioAmplifier           volume_l;
AudioConnection          patchCord8(dlyMixer, 0, volume_master, 0);
