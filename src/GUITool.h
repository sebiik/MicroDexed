...
AudioFilterStateVariable  paraphonicFilter;
...
AudioConnection          patchCord2(queueWaveshaper, 0, paraphonicFilter, 0);
AudioConnection          patchCord3(paraphonicFilter, 0, peak1, 0);
AudioConnection          patchCord4(dcOneVolt, 0, filterModMixer, 0);
AudioConnection          patchCord5(filterEnv, 0, filterModMixer, 1);
AudioConnection          patchCord6(filterModMixer, 0, paraphonicFilter, 1);

AudioConnection          patchCord7(paraphonicFilter, 0, delayFbMixer, 0);
...
AudioConnection          patchCord12(paraphonicFilter, 0, delayMixer, 0);
...
AudioOutputI2S           i2s1;
AudioConnection          masterOutL(chorusMixer_l, 0, i2s1, 0);
AudioConnection          masterOutR(chorusMixer_r, 0, i2s1, 1);
...
AudioConnection          masterOutL(volume_l, 0, i2s1, 0);
AudioConnection          masterOutR(volume_r, 0, i2s1, 1);
AudioControlWM8731master wm8731_1;

#elif defined(TEENSY_DAC)
AudioOutputAnalogStereo  dacOut;
AudioConnection          masterOutL(volume_l, 0, dacOut, 0);
AudioConnection          masterOutR(volume_r, 0, dacOut, 1);
...
AudioConnection          masterOutR(invMixer, 0, dacOut  , 1);

#else
AudioOutputPT8211        pt8211_1;
AudioAmplifier           volume_r;
AudioAmplifier           volume_l;
AudioConnection          patchCord25(chorusMixer_l, 0, volume_l, 0);
AudioConnection          patchCord26(chorusMixer_r, 0, volume_r, 0);
